...
extern void (*touch_callback)() = NULL;
#define XPT2046
...
extern void board_init()
{
    ...
    ledcWrite(ST7796_PWM_CHANNEL_BL, 255);
...
extern void set_led(uint32_t hex_color)
{
...
{
    ledcWrite(LED_PWM_CHANNEL_R, LED_PWM_MAX - red);
    ledcWrite(LED_PWM_CHANNEL_G, LED_PWM_MAX - green);
    ledcWrite(LED_PWM_CHANNEL_B, LED_PWM_MAX - blue);
}

extern void set_backlight(uint8_t brightness)
{
#ifdef ESP32_3248S035C
    ledcWrite(ST7796_PWM_CHANNEL_BL, brightness);
#endif
#ifdef ESP32_2432S024R
    ledcWrite(ILI9341_PWM_CHANNEL_BL, brightness);
#endif
}
